...
def index(request):
    ...
    return render(request, "skydriver/index.html", {"form": form, "cities": cities})
...
def search(request):
    if request.method == "GET":
        ...
        if form.is_valid():
            kwargs = {
                "originLocationCode": form.cleaned_data["origin"],
            ...
            return render(
                request, "skydriver/flight.html", {"flight_offers": get_flight_offers(**kwargs)}
            )
